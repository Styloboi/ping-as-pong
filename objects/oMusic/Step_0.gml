...
if(global.musicOnOff == 0)
{
	...
	/// @DnDHash : 2D1F1BD9
	/// @DnDParent : 76025203
	/// @DnDArgument : "sound" "Ping_as_Pong_Theme"
	/// @DnDSaveInfo : "sound" "Ping_as_Pong_Theme"
	audio_sound_gain(Ping_as_Pong_Theme, 1, 0);
...
else
{
	...
	if(global.musicOnOff == 1)
	{
		...
		/// @DnDSaveInfo : "sound" "Ping_as_Pong_Theme"
		audio_sound_gain(Ping_as_Pong_Theme, 0, 0);
