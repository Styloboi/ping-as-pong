...
if (player == 1)
{
	switch (os_type)
	{
		case os_windows: move = keyboard_check(vk_down) - keyboard_check(vk_up);
	}
	if (mouse_x >= 321)
	{
		switch (os_type)
